...
wp.customHtmlWidgets = ( function( $ ) {
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		renderWhenAnimationDone = function() {
			if ( ! ( wp.customize 'expanded' ) : widgetContainer.hasClass( 'open' ) ) ) { // Core merge: The wp.customize condition can be eliminated with this change being in core: https://github.com/xwp/wordpress-develop/pull/247/commits/5322387d
